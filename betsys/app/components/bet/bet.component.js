...
var BetComponent = (function () {
    ...
    function BetComponent(router, http) {
        ...
        this.curDragIdx = 0;
        // For bet box..
        this.cols = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36];
        this.col_items = [0, 1, 2];
        this.betCells = [];
        ...
        this.offCell = { id: 2, color: "#111111", size: 24, style: "bold", font: "Book Antigua", bgColor: "#FFFFFF", condID: -1, text: "none", orgText: "none" };
        // For trigger data..
        this.triggerData = [];
        this.nextTriggerIdx = 0;
        this.nextTriggerTime = "UNKNOWN";
        this.nextMOCTime = "";
        // For dialog..
        this.antiOpt = false;
        this.voteText = "";
        ...
        this.entryType = 0;
        // For bet margins..
        this.betMargins = [0, 0, 0];
        this.chartBTNMargins = [0, 0, 0];
        this.chartBTNWidth = 26;
        this.betCellWidths = [0, 0, 0];
        // Image size and margin..
        this.betCellImgMarginLeft = 5;
        this.paneCellImgMarginLeft = 5;
        this.bpaneCellImgMarginLeft = 5;
        // For alarm dialog and confirm dialog..
        this.alarmText = "";
        this.alarmOKBtnText = "OK";
        this.confirmBtnText = "OK";
        this.confirmText = "";
        this.confirmConstant = -1;
        ...
        this.accountTableColumn1 = "";
        this.accountTableColumn2 = "";
        // For chart dialog..
        ...
        this.tabID = 1;
        this.curBetPerformance = "";
        this.chartData = {};
        this.db_Selection = {};
        this.db_v4futures = {};
        this.db_v4mini = {};
        this.db_v4micro = {};
        this.db_componentloc = {};
    ...
    BetComponent.prototype.parseBetInfo = function (jsData) {
        ...
        item = Selection['v4micro'];
        this.layoutBet(item, 0, mcdate);
        item = Selection['v4mini'];
        this.layoutBet(item, 1, mcdate);
        item = Selection['v4futures'];
        this.layoutBet(item, 2, mcdate);
        // For recent data loading..
    ...
    BetComponent.prototype.layoutBet = function (item, dragItem, mcdate) {
        ...
        else if (component.indexOf('Anti') != -1) {
    ...
    BetComponent.prototype.putBetOnCond = function (component, dragObj, dragItem, revert) {
        ...
        if (selCond != -1) {
            ...
            var dragItemQueue;
            if (colID != -1 && rowID != -1) {
                dragObj.dragCol = 12 + colID;
                dragObj.dragRow = rowID;
    ...
    BetComponent.prototype.setTriggerData = function (rowData) {
        ...
        jsonArray.sort(function (a, b) {
            var data1 = a[1]['Triggertime'];
            var data2 = b[1]['Triggertime'];
